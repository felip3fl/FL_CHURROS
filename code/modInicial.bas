...
Public Function abrirConexaoBD(variavelBanco, servidor As String, Banco As String) As Boolean
    ...
    If abrirConexaoADO(variavelBanco, servidor, Banco) Then
...
Private Function testeImpressoraFiscal() As Boolean
    testeImpressoraFiscal = CupomVerificaStatus
End Function
